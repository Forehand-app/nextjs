...
function getTournamentStatus(tournament: OrgTournament): "live" | "upcoming" | "past" | "drafts" {
  if (tournament.status === "DRAFT" || tournament.status?.toLowerCase() === "draft") return "drafts";
